...
- `admin-snapshot.json` / `participant-snapshot.json`: 30 IDs, four channel definitions, stopped transport, 27 localized examples plus coarse/ambiguous/unseen cases. Audio readiness is false.
