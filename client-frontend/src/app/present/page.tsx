...
export default function PresentPage() {
  ...
  return <main className="present-shell">
    <header className="present-header"><div className="audience-brand"><span className="brand-mark concerto-mark" aria-hidden="true">c</span><span>Concerto</span></div><span className="live-pill"><i className={offline || !counts ? "" : "ok"} />{offline ? "Reconnecting" : counts ? "Live" : "Connecting"}</span></header>
